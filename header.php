...
<html lang="en">
    <head>
        ...
        <title>Bug Prediction Tool | </title>
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="index.php" class="site_title"><i class="fa fa-bug"></i> <span>Bug Prediction</span></a>
                        </div>
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    ...
                                    <li><a href="exploreDatasets.php"><i class="fa fa-bar-chart"></i> Explore Datasets </a></li>
                                </ul>
                            </div>
