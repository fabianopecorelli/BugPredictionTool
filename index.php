        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content" style="display: block;">
                    <br>
                    <form action="http://localhost:8080/PrimaServlet/InvocareServlet" method="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                        ...
                        <div class="form-group">
                            ...
                            <div  class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="col-md-3">
                                    Bugzilla
                                    <input type="radio" name="issueTracker" class="flat" value="Bugzilla" checked="" required />
                                </div>

                                <div class="col-md-3">
                                    Jira
                                    <input type="radio" class="flat" name="issueTracker" value="Jira" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Issue Tracker URL <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="issueTrackerURL" name="last-name" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <select id="classifier" class="form-control" required="">
